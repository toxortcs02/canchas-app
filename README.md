## ENDPOINTS AGREGADOS
    ...
    - GET /court/{id}/bookings - devolvera el listado de reservas que tiene la cancha con el id enviado en el path
## ENDPOINT(S) MODIFICADO(S)
    ...
    - DELETE /court - Ahora antes de verificar si tiene reservas activas eliminara cualquier reserva que ya haya vencido(reserva con horario previo al momento de la solicitud)
